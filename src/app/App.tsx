...
// import imgVideoBanner from 'figma:asset/c72fd606b8866183803c680b0559f794996a5a0f.png'; // Commented: Figma asset not available in local environment
    ...
    >
      ...
      <div className="flex items-center gap-3">
        ...
        <div
          ...
          style={{ background: colors.colors.mint['700'], border: '1px solid var(--border)' }}
        >
...
function VideoCard() {
  return (
    ...
    >
      {/* Title */}
      <div className="px-5 py-4" style={{ borderBottom: '1px solid var(--muted)' }}>
        <h3 style={{ fontSize: '18px', fontWeight: 'var(--font-weight-semibold)', color: 'var(--foreground)' }}>
          Como configurar
        </h3>
        <p className="mt-1" style={{ fontSize: 'var(--text-caption)', color: 'var(--muted-foreground)' }}>
      ...
      {/* Video Thumbnail */}
      <div
        className="relative cursor-pointer group flex-1 flex items-center justify-center"
        style={{ background: 'linear-gradient(135deg, #2e6b58 0%, #387C2B 100%)', minHeight: '200px' }}
      >
        {/* Play button overlay */}
        <div
      ...
      <div className="px-5 py-4">
        <p style={{ fontSize: 'var(--text-label)', color: 'var(--foreground)', lineHeight: '1.6' }}>
          Aprenda a configurar o módulo Processos passo a passo com nosso tutorial em vídeo.
        </p>
        <button
          className="mt-4 w-full flex items-center justify-center rounded cursor-pointer transition-opacity hover:opacity-90"
          style={{
