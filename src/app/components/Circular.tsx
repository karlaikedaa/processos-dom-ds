      ...
      >
                ...
                {[{ label: 'Enviar imediatamente', value: true }, { label: 'Agendar envio', value: false }].map(opt => (
                  <button
                    ...
                    style={{
                      ...
                      background: envioImediato === opt.value ? 'rgba(214,64,0,0.04)' : 'var(--card)',
                      flex: 1,
                    }}
                  >
                    <div className="w-4 h-4 rounded-full border-2 flex items-center justify-center shrink-0"
                      style={{ borderColor: envioImediato === opt.value ? 'var(--primary)' : 'var(--border)', background: envioImediato === opt.value ? 'var(--primary)' : 'var(--background)' }}>
        ...
        <div className="px-5 py-4 flex items-center justify-end gap-3 shrink-0" style={{ borderTop: '1px solid var(--border)' }}>
          <button
            ...
            style={{ border: '1px solid var(--border)', fontSize: 'var(--text-label)', color: 'var(--foreground)', background: 'var(--background)', fontWeight: 'var(--font-weight-semibold)' }}
          >
...
export function Circular({ onBack = NOOP }: CircularProps) {
  ...
  return (
    ...
    >
      {/* Seção 1: Título */}
      <div style={{ paddingBottom: '16px', display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', gap: '16px' }}>
        <div>
          <h1 style={{
            fontSize: '24px',
        ...
        <div style={{
          ...
          <div className="flex flex-col gap-1" style={{ minWidth: '120px', flex: '0 1 140px' }}>
            ...
            <select value={anoFiltro} onChange={e => setAnoFiltro(e.target.value)}
              ...
              style={{ border: '1px solid var(--border)', background: 'var(--input-background)', fontSize: 'var(--text-label)', color: anoFiltro ? 'var(--foreground)' : 'var(--muted-foreground)' }}>
          ...
          <div className="flex flex-col gap-1" style={{ minWidth: '140px', flex: '0 1 160px' }}>
            ...
            <select value={mesFiltro} onChange={e => setMesFiltro(e.target.value)}
              className="rounded-md px-3 py-2 appearance-none outline-none"
              style={{ border: '1px solid var(--border)', background: 'var(--input-background)', fontSize: 'var(--text-label)', color: mesFiltro ? 'var(--foreground)' : 'var(--muted-foreground)' }}>
              <option value="">Todos</option>
          ...
          <div className="flex flex-col gap-1" style={{ minWidth: '130px', flex: '0 1 150px' }}>
            ...
            <select value={statusFiltro} onChange={e => setStatusFiltro(e.target.value)}
              className="rounded-md px-3 py-2 appearance-none outline-none"
              style={{ border: '1px solid var(--border)', background: 'var(--input-background)', fontSize: 'var(--text-label)', color: statusFiltro ? 'var(--foreground)' : 'var(--muted-foreground)' }}>
              <option value="">Todos</option>
          ...
          <div className="flex flex-col gap-1" style={{ minWidth: '160px', flex: '0 1 200px' }}>
            ...
            <select value={grupoFiltro} onChange={e => setGrupoFiltro(e.target.value)}
              className="rounded-md px-3 py-2 appearance-none outline-none"
              style={{ border: '1px solid var(--border)', background: 'var(--input-background)', fontSize: 'var(--text-label)', color: grupoFiltro ? 'var(--foreground)' : 'var(--muted-foreground)' }}>
              <option value="">Todos</option>
      ...
      {/* Content blocks with 16px spacing */}
      ...
      {confirmDelete !== null && (
        <div className="fixed inset-0 z-50 bg-black/40 flex items-center justify-center p-4">
          <div className="rounded-lg p-6 flex flex-col gap-4" style={{ background: 'var(--card)', maxWidth: '400px', width: '100%', boxShadow: '0 8px 40px rgba(0,0,0,0.18)' }}>
