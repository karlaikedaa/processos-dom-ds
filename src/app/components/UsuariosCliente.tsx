...
import { Search, Plus, ChevronDown, Check, CheckSquare, Square, Info, User } from 'lucide-react';
...
function EditUsuario({ usuario: initial, onClose, onNavigateToConfig }: { usuario: UsuarioCliente; onClose: () => void; onNavigateToConfig: () => void }) {
...
export function UsuariosCliente({ onBack }: { onBack: () => void }) {
  ...
  if (editing) {
    return <EditUsuario usuario={editing} onClose={() => setEditing(null)} onNavigateToConfig={onBack} />;
  }
