...
import {
  Search, Plus, ChevronDown, Info, X, Check, Trash2,
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', height: '100%', paddingLeft: '24px', paddingRight: '24px', background: 'var(--background)' }}>
      ...
      <div style={{ flex: 1, overflowY: 'auto', padding: '24px', background: 'white', borderRadius: '8px', display: 'flex', flexDirection: 'column', gap: 16 }}>
        ...
        <p style={{ fontSize: 'var(--text-label)', fontWeight: 'var(--font-weight-semibold)', color: 'var(--foreground)', margin: 0 }}>100 Modelos de documentos</p>
