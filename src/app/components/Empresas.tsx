...
import {
  Search, Plus, X, ChevronDown, Eye, EyeOff, Trash2,
...
function EditEmpresa({ empresa: initial, onClose, onNavigateToConfig }: { empresa: Empresa; onClose: () => void; onNavigateToConfig: () => void }) {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', height: '100%', background: 'white' }}>
      ...
      {/* Title Section */}
      <div style={{ paddingBottom: '16px', paddingLeft: '24px', paddingRight: '24px' }}>
...
export function Empresas({ onBack }: { onBack: () => void }) {
  ...
  if (editing) return <EditEmpresa empresa={editing} onClose={() => setEditing(null)} onNavigateToConfig={onBack} />;
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', height: '100%', paddingLeft: '24px', paddingRight: '24px', background: 'var(--background)' }}>
      ...
      {/* Content */}
      <div style={{ flex: 1, overflowY: 'auto', padding: '20px 24px', background: 'white', borderRadius: '8px', display: 'flex', flexDirection: 'column', gap: 16 }}>
