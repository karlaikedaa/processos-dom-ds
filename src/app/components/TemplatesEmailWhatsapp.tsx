...
import { Search, Plus, ChevronDown, Info, X, Bold, Italic, Underline, List, AlignLeft, AlignCenter, AlignRight, Link } from 'lucide-react';
...
function EditTemplate({ template, onClose, onNavigateToConfig }: { template?: Template; onClose: () => void; onNavigateToConfig: () => void }) {
    ...
    <div style={{ display: 'flex', flexDirection: 'column', height: '100%', background: '#f9fafc' }}>
      ...
      <div style={{ paddingTop: '24px', paddingBottom: '24px', paddingLeft: '24px', paddingRight: '24px' }}>
        <ConfigBreadcrumb
          ...
          itemLabel={isNew ? undefined : template.nome}
          onNavigateToConfig={onNavigateToConfig}
          onNavigateToMenu={onClose}
        />
      </div>

      {/* Title + Buttons Section */}
      <div style={{ padding: '0 24px 12px', display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', flexShrink: 0, borderBottom: '1px solid var(--border)', background: '#f9fafc' }}>
        <div>
      ...
      {/* Sub info + radio */}
      <div style={{ padding: '12px 24px', background: '#f9fafc', flexShrink: 0, display: 'flex', alignItems: 'center', gap: 24, flexWrap: 'wrap' }}>
        {[
      ...
      {/* Two-column layout */}
      <div style={{ flex: 1, overflowY: 'auto', padding: '0 24px 24px', display: 'flex', gap: 20, alignItems: 'flex-start' }}>
        {/* Left panel - form */}
...
export function TemplatesEmailWhatsapp({ onBack }: { onBack: () => void }) {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', height: '100%', paddingLeft: '24px', paddingRight: '24px', background: 'var(--background)' }}>
      ...
      {/* Content */}
      <div style={{ flex: 1, overflowY: 'auto', padding: '24px', background: 'white', borderRadius: '8px', display: 'flex', flexDirection: 'column', gap: 16 }}>
