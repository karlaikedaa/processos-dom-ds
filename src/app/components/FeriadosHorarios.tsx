...
export function FeriadosHorarios({ onBack }: { onBack: () => void }) {
  ...
  return (
    <div className="flex flex-col h-full px-6" style={{ background: 'var(--background)' }}>
      {/* Breadcrumb */}
      ...
      {/* Header with tabs */}
      <div className="bg-white rounded-t-lg px-6 pt-4 shrink-0" style={{ borderBottom: '1px solid var(--border)' }}>
      ...
      {/* Content */}
      <div className="flex-1 overflow-auto p-6 bg-white rounded-b-lg">
