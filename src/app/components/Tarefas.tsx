...
> = {
  ...
  'Aguardando aprovação': { color: colors.colors.purple['500'], bg: 'rgba(144,78,177,0.10)', icon: PauseCircle },
...
export function Tarefas() {
  ...
  return (
    <div className="flex flex-col min-h-screen" style={{ background: colors.elements['background 02'] }}>
      {/* Page Title - directly on gray background */}
      ...
      {/* Filters Block - white block with 24px horizontal padding */}
        ...
        {selectedTask && (
          ...
          >
            ...
            <Collapsible open={checklistOpen} onOpenChange={setChecklistOpen}>
              <div className="p-4">
                <CollapsibleTrigger asChild>
                  <button className="flex items-center gap-2 cursor-pointer hover:opacity-80 transition-opacity mb-3">
                    {checklistOpen ? (
                      <ChevronDown size={16} style={{ color: 'var(--muted-foreground)' }} />
                    ) : (
                      <ChevronRight size={16} style={{ color: 'var(--muted-foreground)' }} />
      ...
      {selectedTask && (
      <div
        className="bg-white rounded-b-lg px-6 py-3 flex items-center justify-between"
